...
// Globals
var core = {addon: {id:'OSXMediaTap@jetpack'}}; // all that should be needed is core.addon.id, the rest is brought over on init
...
function initAndRegisterAbout() {
	...
	AboutPage.prototype = Object.freeze({
		...
		contractID: '@mozilla.org/network/protocol/about;1?what=osxmediatap',
